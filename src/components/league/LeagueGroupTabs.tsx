        ...
        {tabs.map(t => {
          ...
          return (
            <Link
              ...
              className={`shrink-0 px-3.5 py-2.5 lg:px-5 lg:py-3 -mb-px border-b-2 font-bold text-sm lg:text-[15px] min-h-[44px] flex items-center transition-colors duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--mm-rule)] focus-visible:ring-offset-1 ${
                active
