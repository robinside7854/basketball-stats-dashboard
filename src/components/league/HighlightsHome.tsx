...
export default function HighlightsHome({ data, orgSlug, leagueId }: Props) {
  ...
  return (
    <>
      <SectionCard variant="stack" background="var(--mm-panel-alt)" pad="none">
        {/* 헤더 */}
        <header
        ...
        >
          <div className="min-w-0">
            <div className="flex items-center gap-2 min-w-0">
              ...
              {hasClutch && (
                <span
                  className="text-xs font-semibold px-1.5 py-0.5 ml-1"
                  style={{
                    background: '#ef4444',
                    color: '#fff',
                    borderRadius: '3px',
          ...
          <Link
            href={roundHref}
            className="inline-flex items-center gap-1 text-xs font-semibold min-h-11 px-2 -mx-2 cursor-pointer transition-colors"
        ...
        */}
            ...
            {orderedClips.map(({ c, i }) => {
              ...
              return (
                ...
                >
                  ...
                  {kindStyle && kindLabel ? (
                    <div
                      className="flex items-center justify-center gap-1 py-1.5 text-xs sm:text-sm font-semibold"
                    ...
                    <div
                      className="flex items-center justify-center gap-1 py-1.5 text-xs font-semibold"
                  ...
                  {c.opponent_name && (
                    <div
                      ...
                      style={{ color: 'var(--mm-muted)' }}
                    >
                      <span className="font-bold" style={{ color: 'var(--mm-muted)' }}>vs</span>
                      <span
        ...
        {hasClutch && data.totalClips > 0 && (
          <div
            className="px-4 sm:px-6 md:px-10 pb-4 md:pb-5 text-xs font-bold"
            style={{ color: 'var(--mm-muted)' }}
          >
