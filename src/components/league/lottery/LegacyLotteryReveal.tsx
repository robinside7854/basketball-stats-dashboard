'use client'
// [레거시 2D 폴백] WebGL 을 쓸 수 없는 기기에서만 마운트된다.
// 3D 버전(DraftLotteryReveal)과 페이즈·타이밍·onClose 계약이 동일해야 한다 —
// 같은 추첨을 보는 클라이언트끼리 화면이 달라도 닫히는 시점은 같아야 하기 때문.
//
...
export default function LegacyLotteryReveal({ order, odds, teams, onClose }: Props) {
