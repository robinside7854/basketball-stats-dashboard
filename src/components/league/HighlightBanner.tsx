      ...
      <div className="relative rounded-2xl bg-gradient-to-r from-amber-950/40 via-gray-900 to-orange-950/40 border border-amber-700/30 overflow-hidden">
        ...
        <div className="relative px-5 lg:px-6 pt-3 lg:pt-4 pb-2 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs lg:text-xs text-gray-500">· {dateRangeLabel}</span>
          </div>
        </div>
        <div className="relative grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-gray-800/60">
          ...
          {mvp ? (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-jersey text-xs lg:text-xs text-amber-400 font-bold uppercase tracking-[0.18em]">이 주의 MVP</p>
                <p className="text-base lg:text-xl font-black text-white truncate group-hover:text-amber-200 transition-colors flex items-center gap-1.5 flex-wrap">
                  <span>{mvp.name}</span>
                  {mvp.number != null && <span className="jersey-num text-xs lg:text-sm">{mvp.number}</span>}
                </p>
                <p className="text-xs lg:text-sm text-gray-500 mt-0.5">{mvp.gp}경기 · {mvp.pts}pts 누적</p>
              </div>
              <div className="text-right shrink-0">
                <p className="font-display text-5xl lg:text-6xl text-amber-300 leading-none">
                  <CountUp value={mvp.ppg} decimals={1} />
                </p>
                <p className="font-jersey text-xs lg:text-xs text-gray-500 font-bold mt-1 tracking-widest">PPG</p>
              </div>
            </button>
          ...
          {hotHand ? (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-jersey text-xs lg:text-xs text-orange-400 font-bold uppercase tracking-[0.18em]">Hot Hand · 3P%</p>
              ...
              <div className="text-right shrink-0">
                ...
                <p className="font-jersey text-xs lg:text-xs text-gray-500 font-bold mt-1 tracking-widest">3P%</p>
              </div>
            </button>
          ) : <div className="px-5 py-4 text-center text-xs text-gray-600">데이터 없음</div>}
        </div>
