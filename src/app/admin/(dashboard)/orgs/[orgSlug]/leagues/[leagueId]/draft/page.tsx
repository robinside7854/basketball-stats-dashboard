  ...
  return (
    <div className="space-y-5 p-6">
      <div className="flex items-center gap-3">
        <Link href={`/admin/orgs/${orgSlug}/leagues/${leagueId}`} className="text-[var(--mm-muted)] hover:text-[var(--mm-ink)] transition-colors p-1.5 rounded-md hover:bg-[var(--mm-panel-alt)] cursor-pointer">
          <ArrowLeft size={18} />
        </Link>
        <div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-1">
                ...
                <p className="text-xs text-[var(--mm-muted)] leading-relaxed">
                  ...
                  어드민은 <strong className="text-amber-400">코드 발급</strong>과 <strong className="text-amber-400">공유 링크 생성</strong>까지만 수행하면 됩니다.
                </p>
              </div>
            </div>
          </div>
