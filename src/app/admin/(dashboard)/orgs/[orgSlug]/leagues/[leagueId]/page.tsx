...
function PlayersTab({
  ...
  const assignedPlayerIds = new Set(teams.flatMap(t => t.players.map(p => p.player_id)))
          ...
          <div key={team.id} className="bg-gray-900 border border-gray-800 rounded-xl p-5 space-y-3">
            ...
            {team.players.length === 0 ? (
              ...
              <div className="space-y-1">
                {team.players.map(p => (
                  <div key={p.player_id} className="flex items-center justify-between py-1 px-2 rounded hover:bg-gray-800">
                    <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() => unassignPlayer(p.player_id, team.id)}
