...
- ⚠ **사용자 확인 필요 — 자유투 룰이 슬롯마다 갈렸다.** 같은 경기 안에서도 쿼터별로 다르다.
  `free_throw`(정식 1점) 슬롯 1·2·6 / `ft_2pt`(자체전 1구 2점) 슬롯 3·4·7·8·9·10.
  성공분 기준 현재 19점(1점 5 + 2점 14). 전부 1점이면 -7점, 전부 2점이면 +5점. 승패는 안 바뀐다.
